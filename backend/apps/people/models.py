...
class StudentGuardian(models.Model):
    ...
    class Meta: unique_together=(('student','guardian'),)
...
class TeachingAssignment(models.Model):
    ...
    class Meta: unique_together=(('teacher','class_room','subject'),)
class Enrollment(models.Model):
    ...
    class Meta: unique_together=(('student','school','year','grade','class_room'),)
