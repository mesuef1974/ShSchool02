...
from apps.refdata.models import Nationality, AbsenceReason
class Command(BaseCommand):
    help='Load initial reference data'
    def handle(self,*args,**kwargs):
        Nationality.objects.get_or_create(code='QA', defaults={'name_ar':'قطري','name_en':'Qatari'})
        AbsenceReason.objects.get_or_create(code='SICK', defaults={'name_ar':'مرض'})
